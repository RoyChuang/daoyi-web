...
const Article = () => {
    return (
        ...
        <PageLayout blogwithsidebar>
            ...
            11This is a demo file for your first article, you can copy code / structure of this file into new file and replace content with your content to create new articles.
