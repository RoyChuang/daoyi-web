                ...
                <Link key={book.id} href={book.href} passHref>
                  <a className="block group">
                    <div className="bg-white rounded-lg shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100 px-3 py-2 flex items-center gap-2">
                      {/* 書籍圖示 */}
                      <div className="w-8 h-8 flex-shrink-0 rounded-full bg-gradient-to-br from-amber-50 to-orange-100 flex items-center justify-center">
                        <FontAwesomeIcon icon={book.icon} className="text-sm text-amber-600 group-hover:scale-110 transition-transform duration-300" />
                      </div>
                      <span className="text-sm font-medium text-[#334155] group-hover:text-green-600 transition-colors duration-300">
                        {book.title}
                      </span>
                    </div>
                  </a>
